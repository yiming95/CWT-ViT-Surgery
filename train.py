...
def main(args):
    ...
    if os.path.exists(args.weight_path) is False:
        os.makedirs(args.weight_path)

    tb_writer = SummaryWriter()

    train_images_path, train_images_label, val_images_path, val_images_label = read_split_data(args.task, args.data_path, args.validation_option)
...
if __name__ == '__main__':    
    ...
    parser.add_argument('--data-path', type=str,
                        default="./Processed_dataset/Suturing_left_mtm")
    parser.add_argument('--validation-option', type=str,
                        default= "SU_LOSO_1")
